...
\begin{enumerate}[leftmargin=*]
    ...
    \begin{itemize}
        ...
        \item $X_7 \in \{0, 1\}$: Volatile organosulfur biosignature (dimethyl sulfide, $\mathrm{DMS}$, $\mathrm{C}_2\mathrm{H}_6\mathrm{S}$).
