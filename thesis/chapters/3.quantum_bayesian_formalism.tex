...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.70\textwidth, height=0.52\textheight, keepaspectratio]{figures/3.quantum_bayesian_formalism/circuito_operador_A.png}
    ...
    \label{fig:circuito_operador_A}
\end{figure}

As depicted in Figure \ref{fig:circuito_operador_A}, the state preparation operator $\mathcal{A}$ compiles the complete multi-gas dependency structure into a coherent, barrier-free quantum subcircuit.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\textwidth, height=0.40\textheight, keepaspectratio]{figures/3.quantum_bayesian_formalism/figura_geometria_grover.png}
...
\subsection{Matrix Algebra of Grover's Iteration Operator $\mathcal{Q}$}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth, height=0.45\textheight, keepaspectratio]{figures/3.quantum_bayesian_formalism/circuito_operador_grover.png}
    ...
    \label{fig:circuito_operador_grover}
\end{figure}
...
\end{equation}
Figure \ref{fig:circuito_operador_grover} illustrates the full quantum circuit synthesis of this composite operator.

\subsection{Spectral Analysis and Eigenvalues of the $\mathcal{Q}$ Operator}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.90\textwidth, height=0.50\textheight, keepaspectratio]{figures/3.quantum_bayesian_formalism/circuito_qae_maestro.png}
    ...
    \label{fig:circuito_qae_maestro}
\end{figure}
...
\end{equation}
Figure \ref{fig:circuito_qae_maestro} shows the end-to-end master circuit architecture integrating the evaluation register, state register, Grover cascade, and IQFT block.

\subsection{Mathematical Proof of the $\mathcal{O}(1/M)$ Convergence Limit}
...
\midrule
\textbf{Error Correction (QEC)} & Real-time syndrome measurement & Millions of physical qubits & Future FTQC era \\
\textbf{Error Mitigation (QEM)} & Classical post-processing of noise & Zero extra qubits; sampling overhead & Viable on NISQ hardware \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.90\textwidth, height=0.45\textheight, keepaspectratio]{figures/3.quantum_bayesian_formalism/circuito_nisq_plegado_lambda3.png}
    ...
    \label{fig:circuito_nisq_plegado}
\end{figure}
...
\end{equation}
Because $U^\dagger U = I$, the logical operation is unchanged, but the physical gate count and interaction with the environment are scaled by $\lambda \in \{1, 3, 5, \dots\}$, as depicted in Figure \ref{fig:circuito_nisq_plegado}.
