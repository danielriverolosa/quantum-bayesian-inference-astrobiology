...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/1.introduction/espectro_k218b.png}
...
To model these intricate dependencies, astrobiologists formalize planetary systems as Bayesian Networks (BNs)---Directed Acyclic Graphs (DAGs) wherein nodes represent discrete or discretized physical parameters and directed edges quantify causal or photochemical conditional dependencies \cite{nielsen2010}.

\input{figures/1.introduction/figura1_dag_k218b.tex}
