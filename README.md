...
| 🖼️ **[Pipeline Architecture](figures/)** | Master 6-step animated quantum Bayesian pipeline, interactive web dashboard, and vector assets. | [`croquis_keynote_2row.svg`](figures/croquis_keynote_2row.svg) &bull; [`interactive_overview.html`](figures/interactive_overview.html) &bull; [`croquis_keynote_2row_static.svg`](figures/croquis_keynote_2row_static.svg) |
